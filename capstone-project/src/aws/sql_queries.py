...
create_fact_complaints_table  = ("""
    ...
    (
        ...
        received_date      DATE NOT NULL REFERENCES dim_dates (date),
        sent_date          DATE NOT NULL REFERENCES dim_dates (date),
...
create_table_queries = [ create_stg_raw_complaints_table, create_stg_raw_geo_cities_table,create_stg_raw_geo_counties_table, create_stg_raw_geo_states_table, create_stg_raw_geo_zip_table, create_dim_companies_table, 
                        create_dim_complaints_table, create_dim_dates_table, create_dim_geographies_table, create_dim_issues_table, create_dim_products_table, create_dim_tags_table,
                        create_fact_complaints_table ]

drop_table_queries = [ stg_raw_geo_zip_table_drop, stg_raw_geo_states_table_drop, stg_raw_complaints_table_drop, stg_raw_geo_cities_table_drop, stg_raw_geo_cities_table_drop, stg_raw_geo_counties_table_drop,
                      dim_dates_table_drop, dim_products_table_drop, dim_tags_table_drop, dim_issues_table_drop, dim_companies_table_drop, dim_complaints_table_drop, dim_geographies_table_drop, 
                      fact_complaints_table_drop ]